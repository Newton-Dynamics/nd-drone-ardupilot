...
-- New CG and Canard design::
MotorsMatrix:add_motor_raw(M1, -0.484, 0.852, AP_MOTORS_MATRIX_YAW_FACTOR_CW, 1);
MotorsMatrix:add_motor_raw(M2, 0.484, -1, AP_MOTORS_MATRIX_YAW_FACTOR_CW, 5);
MotorsMatrix:add_motor_raw(M3, -0.484, 0.337, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 2);
MotorsMatrix:add_motor_raw(M4, -0.484, -1, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 4);

MotorsMatrix:add_motor_raw(M5, 0.484, 0.852, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 8);
MotorsMatrix:add_motor_raw(M6, 0.484, -0.189, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 6);
MotorsMatrix:add_motor_raw(M7, 0.484, 0.337, AP_MOTORS_MATRIX_YAW_FACTOR_CW, 7);
MotorsMatrix:add_motor_raw(M8, -0.484, -0.189, AP_MOTORS_MATRIX_YAW_FACTOR_CW, 3);

--[[ 
-- disrupted case: out of order additions
MotorsMatrix:add_motor_raw(M1, -0.48, 0.85, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  1)
MotorsMatrix:add_motor_raw(M2, 0.441, -1, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  5)
MotorsMatrix:add_motor_raw(M3, -0.441, 0.44, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 2)
MotorsMatrix:add_motor_raw(M4, -0.441, -0.97, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 4)

MotorsMatrix:add_motor_raw(M5, 0.441, 0.84, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 8)
